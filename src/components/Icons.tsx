// Premium SVG icons — Lucide-style stroke icons.
// Used in the sidebar for a professional, consistent look.
...
export function QuotationsIcon({ className }: IconProps) {
  return (
    <Icon className={className}>
...
export function CashbookIcon({ className }: IconProps) {
  return (
    <Icon className={className}>
      <rect x="2" y="5" width="20" height="14" rx="2" />
      <line x1="2" y1="10" x2="22" y2="10" />
...
export function InstallationsIcon({ className }: IconProps) {
  return (
    <Icon className={className}>
...
// Map of icon name → component, used by Shell to render the right icon
export const ICONS: Record<string, React.ComponentType<IconProps>> = {
  ...
  report: ReportIcon,
  installations: InstallationsIcon,
  amc: AmcIcon,
